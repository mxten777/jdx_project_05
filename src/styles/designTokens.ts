...
export const themes = {
  light: {
    ...
    text: {
      ...
      muted: designTokens.colors.secondary[400],
    },
    border: designTokens.colors.secondary[200],
  },
  dark: {
    background: designTokens.colors.secondary[900],
    surface: designTokens.colors.secondary[800],
    text: {
      primary: designTokens.colors.secondary[100],
      secondary: designTokens.colors.secondary[300],
      muted: designTokens.colors.secondary[500],
    },
